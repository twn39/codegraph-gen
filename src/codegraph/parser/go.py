    ...
    def parse_file(self, file_path: Path, workspace_dir: Path) -> ExtractionResult:
        ...
        def walk(node):
            ...
            if node_type == "type_declaration":
                ...
                for child in node.children:
                    if child.type == "type_spec":
                        ...
                        if name_node:
                            ...
                            # Determine type: struct or interface
                            sym_type = "struct"
                ...
                # import "fmt" or name "path/to/module"
                path_node = node.child_by_field_name("path")
                if path_node:
                    import_path = source[path_node.start_byte:path_node.end_byte].decode("utf-8", errors="replace")
                ...
                if func_node:
                    ...
                    # Walk parent path to find nearest containing function/method ID
                    # For simplicity, we search for closest containing function_declaration or method_declaration
